 ...
 */
export class Axis {
    static #canConstruct = true;
    static #_OBSERVING = new Axis('Observing');
    static #_DECIDING = new Axis('Deciding');
     ...
     */
    static get All() {
        return [this.OBSERVING, this.DECIDING];
    }
    ...
    constructor(axisName) {
        if (new.target === Axis && !Axis.#canConstruct) throw new Error(
...
export class Charge {
    static #canConstruct = true;
    static #_INTROVERTED = new Charge('Introverted');
    static #_EXTROVERTED = new Charge('Extroverted');
    static #canConstruct = false;
     ...
     */
    static get All() {
        return [this.INTROVERTED, this.EXTROVERTED];
    }
     ...
     */
    constructor(chargeName) {
        if (new.target === Charge && !Charge.#canConstruct) throw new Error(
            "Private constructor. Use static properties and methods."
        );
        
        this.name = chargeName;
        
        if (new.target === Charge) {
            Object.freeze(this);
        }
    }
...
export class HumanNeed {
    static #canConstruct = true;
    static #_DI_SELF = new HumanNeed('Di');
    static #_DE_TRIBE = new HumanNeed('De');
    static #_OI_ORGANIZE = new HumanNeed('Oi');
    static #_OE_GATHER = new HumanNeed('Oe');
    static #canConstruct = false;
     ...
     */
    static get All() {
        return [this.DI_SELF, this.DE_TRIBE, this.OI_ORGANIZE, this.OE_GATHER];
    }
    ...
    static fromName(name) {
        return this.All.find((value) => {
            return value.name === name || value.shortName === name;
        });
    }
    ...
    constructor(humanNeedShortName) {
        ...
        this.shortName = humanNeedShortName;
